...
const MainPage = () => {
  ...
  useEffect(()=>{
    electron.ipcRenderer.send("get:config",config)
  ...
  electron.ipcRenderer.on("set,TextBox",(event,newRecords)=>{
...
const handleSetConfig = (e) => {
  ...
  return (
    <div className="flex flex-col justify-between h-screen p-4 bg-zinc-800">
      ...
      <div className='flex flex-row items-center justify-end w-full h-10 p-4 text-gray-300'>
            ...
            <div className='flex flex-row items-center justify-end w-full h-10 p-4 text-gray-300'>
                  <h1 className='flex items-center justify-start w-full h-16 text-gray-300'>Time(s):</h1>
            </div>
            <div className='flex flex-row items-center justify-center w-full h-16 p-4 text-gray-300 shadow  bg-zinc-600'>
                <input onChange={handleSetConfig} value={config.Time} name={'Time'} className='flex items-center justify-end w-6/12 h-12 text-center text-gray-300 border border-zinc-900 bg-zinc-900' />
            </div>
